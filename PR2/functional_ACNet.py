...
def createmodel():
    ...
    x=layers.TimeDistributed(layers.Conv2D(filters=RNN_SIZE - GOAL_REPR_SIZE,kernel_size=1,strides=1,padding="valid",data_format="channels_last",kernel_initializer=w_init, activation=None))(x)
